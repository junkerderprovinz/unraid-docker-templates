...
# Upstream repository: https://github.com/standardnotes/server
# Upstream license: GNU AGPL-3.0 (see https://github.com/standardnotes/server/blob/main/LICENSE).
# This file is redistributed under the same terms as the upstream project; it is
# bundled with this Unraid template so the LocalStack companion container can be
# initialised with the required topics/queues out of the box.
#
